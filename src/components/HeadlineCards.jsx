...
const HeadlineCards = () => {
  return (
    ...
    font-bold italic font-serif  bg-slate-900'>
      {/* Card */}
      <div className='rounded-xl relative'>
        ...
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white '>
          ...
          <button className='border-sky-700 bg-slate-900 text-sky-700 font-bold italic font-serif mx-2 absolute bottom-4'>Order Now</button>
        </div>
        <img
      ...
      <div className='rounded-xl relative'>
        ...
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          ...
          <button className='border-sky-700  bg-slate-900 text-sky-700 mx-2 absolute bottom-4'>Order Now</button>
        </div>
        <img
        className='max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl'
